...
Although it is still supported for simple cases and for backward compatibility, users should migrate to [CSS style](style), which supports more complex styling scenarios.
