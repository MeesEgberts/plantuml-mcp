...
This syntax is compatible with [OrgMode](https://en.wikipedia.org/wiki/Org-mode) and its [tree syntax](https://orgmode.org/features.html).
...
This syntax is compatible with [Markdown](https://en.wikipedia.org/wiki/Markdown).

### Markdown Header

You can use [Markdown header](https://daringfireball.net/projects/markdown/syntax#header):
```plantuml
@startmindmap
# root node
...
You can use [Markdown list](https://daringfireball.net/projects/markdown/syntax#list) or [GFM list](https://github.github.com/gfm/#lists):
```plantuml
@startmindmap
* root node
    * some first level node
